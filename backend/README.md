...
## Project Structure
    ...
    ├── testapiautodatamode_54658  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamode_54658`
...
2. Clone this repo and `cd testapiautodatamode_54658`
